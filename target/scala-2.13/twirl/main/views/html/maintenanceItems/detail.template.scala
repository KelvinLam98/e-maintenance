    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a id="deleteUser" href=""""),_display_(/*37.43*/routes/*37.49*/.MaintenanceItems.delete(maintenanceItem.id.get)),format.raw/*37.97*/("""" onclick="return confirm('Are you sure you want to delete this item?');">
