    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <a id="updateUser" href=""""),_display_(/*32.43*/routes/*32.49*/.MaintenanceItems.update(maintenanceItem.id.get)),format.raw/*32.97*/("""">
                    <button type="button" class="btn btn-primary badge">
                        Update
                    </button>
                </a>
                <a id="deleteUser" href=""""),_display_(/*37.43*/routes/*37.49*/.MaintenanceItems.delete(maintenanceItem.id.get)),format.raw/*37.97*/("""">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>"""),_display_(/*49.34*/maintenanceItem/*49.49*/.item_code),format.raw/*49.59*/("""</td>
                        </tr>
                        <tr>
                            <th>Name</th>
                            <td>"""),_display_(/*53.34*/maintenanceItem/*53.49*/.item_name),format.raw/*53.59*/("""</td>
                        </tbody>
                    </table>
                </div>
            </div>
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: f28845aac249953299b05462fda0b42dddd7fab9
                  MATRIX: 826->1|1035->114|1063->117|1092->138|1131->140|1159->142|1229->185|1257->186|1293->196|1385->262|1398->267|1433->282|1487->309|1515->310|1558->326|1758->498|1787->499|1827->511|1859->516|1873->521|1909->536|1964->563|1993->564|2037->580|2237->752|2266->753|2307->766|2339->771|2353->776|2389->791|2454->828|2483->829|2527->845|2734->1024|2763->1025|2792->1026|2825->1032|3227->1407|3242->1413|3311->1461|3543->1666|3558->1672|3627->1720|4162->2228|4186->2243|4217->2253|4388->2397|4412->2412|4443->2422
                  LINES: 23->1|28->1|29->2|29->2|29->2|30->3|31->4|31->4|33->6|35->8|35->8|35->8|35->8|35->8|36->9|38->11|38->11|39->12|39->12|39->12|39->12|39->12|39->12|40->13|42->15|42->15|43->16|43->16|43->16|43->16|43->16|43->16|44->17|46->19|46->19|46->19|47->20|59->32|59->32|59->32|64->37|64->37|64->37|76->49|76->49|76->49|80->53|80->53|80->53
                  -- GENERATED --
              */
