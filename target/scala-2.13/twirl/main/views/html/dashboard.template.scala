            ...
            columns: [
                """),format.raw/*11.17*/("""{"""),format.raw/*11.18*/(""" """),format.raw/*11.19*/("""data: 'item_name',
                    "render": function(data, type, full, meta)"""),format.raw/*12.63*/("""{"""),format.raw/*12.64*/("""
                        """),format.raw/*13.25*/("""return '<a href="dashboard/pending/' + full.id + ' " class="link">' + data + '</a>';
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  ...
                  HASH: a9cba068e5f5389cd0cd8ef2939b9f7de4ebab90
                  MATRIX: 796->1|972->82|1002->87|1031->108|1070->110|1098->112|1168->155|1196->156|1232->166|1286->193|1314->194|1355->208|1522->347|1551->348|1580->349|1690->431|1719->432|1773->458|1907->564|1936->565|1982->583|2011->584|2058->603|2087->604|2116->605|2161->622|2190->623|2237->642|2266->643|2295->644|2346->667|2375->668|2422->687|2451->688|2480->689|2597->778|2626->779|2684->809|2775->872|2804->873|2850->891|2879->892|2926->911|2955->912|2984->913|3026->927|3055->928|3097->942|3166->984|3195->985|3230->993|3258->994
