...
user""",
  ...
  // @LINE:96
  private[this] lazy val appcontrollers_WorkOrders_postUpdateWorkOrder60_route = Route("POST",
  ...
  private[this] lazy val appcontrollers_WorkOrders_postUpdateWorkOrder60_invoker = createInvoker(
  ...
  // @LINE:98
  private[this] lazy val appcontrollers_WorkOrders_postCreateWorkOrderWithSample61_route = Route("POST",
  ...
  private[this] lazy val appcontrollers_WorkOrders_postCreateWorkOrderWithSample61_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:96
    case appcontrollers_WorkOrders_postUpdateWorkOrder60_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        appcontrollers_WorkOrders_postUpdateWorkOrder60_invoker.call(WorkOrders_5.postUpdateWorkOrder(id))
      }
  
    // @LINE:98
    case appcontrollers_WorkOrders_postCreateWorkOrderWithSample61_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        appcontrollers_WorkOrders_postCreateWorkOrderWithSample61_invoker.call(WorkOrders_5.postCreateWorkOrderWithSample(id))
      }
